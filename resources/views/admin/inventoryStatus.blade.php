        ...
        <div class="content">
            <div class="page-header">
                <div class="page-title">
                    ...
                    <h6>Current Stocks in the Inventory</h6>
                </div>
                <div class="page-btn">
                    <a href="MenuAdd.html" class="btn btn-added" data-bs-toggle="modal" data-bs-target="#addrecipe"><img
                            src="assets/img/icons/plus.svg" alt="img">Add Inventory</a>
                </div>
            </div>
